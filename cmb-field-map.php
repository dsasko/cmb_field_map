...
class PW_CMB2_Field_Google_Maps {
	...
	public function location() {
		define( 'CMB2_FGM_URL', plugin_dir_url( __FILE__ ) );
	}
	...
	public function setup_admin_scripts() {
		...
		wp_enqueue_script( 'pw-google-maps', CMB2_FGM_URL . 'js/script.js', array( 'pw-google-maps-api' ), self::VERSION );
		wp_enqueue_style( 'pw-google-maps', CMB2_FGM_URL . 'css/style.css', array(), self::VERSION );
	}
}
